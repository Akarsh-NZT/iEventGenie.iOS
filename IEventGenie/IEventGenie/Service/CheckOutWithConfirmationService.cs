...
{
	public class CheckOutWithConfirmationService : ICheckOutWithConfirmationService
	{
		#region SERVICE
		public async  Task<ResponseModel<CheckInWithConfirmationCodeModel>> GetCheckOutWithConfirmationCodeStatus(string confirmationNumber,string eventId,string attendeeId)
		{
			...
			{																		
				...
				String url = WebServiceHelper.GetWebServiceURL(AppConstant.CHECK_OUT_WITH_CONFIRMATION_CODE,param);
				...
				System.Diagnostics.Debug.WriteLine ("ChekOutWithConfirmation Code response : "+res);
